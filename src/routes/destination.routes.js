...
import { createUserDestination, getAllUserDestinations, getUserDestinationById, updateUserDestination, deleteUserDestination, searchDestination } from "../controllers/destination.controller.js"
...
router.get("/search", verifyJWT, searchDestination)
